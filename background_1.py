""" background_1_v1
    In this version I will get lines to run down the screen as if the road
    is moving"""
...
lines = pygame.transform.scale(pygame.image.load('road.png'), (50, 700))
lines_2 = pygame.transform.scale(pygame.image.load('road.png'), (50, 700))
# Two lines are defined so when one disappears off screen, a second can replace
screen.blit(background, (0, -3))  # Define Background
screen.blit(lines, (327, -20))  # Define lines
pygame.display.update()  # Update screen


def game_loop():
    road_x = 327  # Set position
    road_y = 0
    road2_y = 701
