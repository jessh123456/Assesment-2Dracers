""" endgame_5
    I re-did the controls of the player's car by putting it all into a class.
    This way I could use collidesprite() to check for collisions and end
    the game if the players car was touching another car."""
