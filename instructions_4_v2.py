""" instructions_4_v2
    I thought the instructions stating to use the arrow keys might be confusing
    for people, as only the left and right keys work. To help with this I
    created a picture on paint of left and right arrow keys."""
