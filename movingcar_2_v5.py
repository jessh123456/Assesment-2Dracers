""" movingcar_2_v4
    I found that it was too easy to win the game with the car being able to
    move up, don, left, and right. I have decided to change it so that the
    red car can only move side to side, making it more challenging."""
