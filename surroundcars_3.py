""" surroundcars_3
    I have created a scene where cars randomly run down the road in one of
    four lanes and one of five coloured cars. The only problem is occasionally
    between the road lines and the background there is a gap and the car
    appears to "glitch" but it does not affect the smoothness of driving
    the car or other moving cars. The other problems is that the cars that
    come down the screen appear too late."""
...
def game_loop():
    ...
    car_x4 = 0
    car_x5 = 0
    car_y = 0  # Y position for each of the random cars
    car_y2 = 0
    car_y3 = 0
    car_y4 = 0
    car_y5 = 0
