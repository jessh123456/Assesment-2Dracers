""" surroundcars_3_v2
    The red car and occasionally the other cars would "glitch" when going
    side to side. I have fixed this by making the roads slightly longer so
    they will overlap each other and cover the gap."""
