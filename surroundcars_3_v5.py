""" surroundcars_3_v5  TRIALLING
    Version 4 has the cars moving randomly down the screen at different speeds,
    but sometimes the cars overlap each other. I have tried to fix this so they
    slow to the lowest speed and don't overlap, however this method didn't
    work."""
    ...
    while not quit_game:  # For future use when the 'x' in the corner is used
        while not game_over:
            ...
            if run:
                ...
                if car_y5 != 0 or car_y3 != 0 or car_y != 0 or car_y4 != 0:
                    if car_y5 - 80 < car_y2 or car_y3 - 80 < car_y2 \
                            or car_y - 80 < car_y2 or car_y4 - 80 < car_y2:
                        if car_x4 == car_x2 or car_x5 == car_x2 or \
                                car_x3 == car_x2 or car_x == car_x2:
                            car_move = 5  # if car is on another, set speed 5
            ...
            if run3:
                ...
                if car_y5 != 0 or car_y2 != 0 or car_y != 0 or car_y4 != 0:
                    if car_y5 - 80 < car_y3 or car_y2 - 80 < car_y3 \
                            or car_y - 80 < car_y3 or car_y4 - 80 < car_y3:
                        if car_x4 == car_x3 or car_x5 == car_x3 or \
                                car_x2 == car_x3 or car_x == car_x3:
                            car_move = 5  # if car is on another, set speed 5
            ...
            if run4:
                ...
                if car_y5 != 0 or car_y2 != 0 or car_y3 != 0 or car_y != 0:
                    if car_y5 - 80 < car_y4 or car_y2 - 80 < car_y4 \
                            or car_y3 - 80 < car_y4 or car_y - 80 < car_y4:
                        if car_x == car_x4 or car_x5 == car_x4 or \
                                car_x2 == car_x4 or car_x3 == car_x4:
                            car_move = 5  # if car is on another, set speed 5
            ...
            if run5:
                ...
                if car_y != 0 or car_y2 != 0 or car_y3 != 0 or car_y4 != 0:
                    if car_y - 80 < car_y5 or car_y2 - 80 < car_y5 \
                            or car_y3 - 80 < car_y5 or car_y4 - 80 < car_y5:
                        if car_x4 == car_x5 or car_x == car_x5 or \
                                car_x2 == car_x5 or car_x3 == car_x5:
                            car_move5 = 5  # if car is on another, set speed 5
            ...
            if run6:
                if car_y == -150:  # only choose colour and lane once
                    ...
                    car_x = random.choice(car_x_option)  # Choose a lane
                    car_move = random.randrange(5, 9)  # Random speed
                if car_y5 != 0 or car_y2 != 0 or car_y3 != 0 or car_y4 != 0:
                    if car_y5 - 80 < car_y or car_y2 - 80 < car_y \
                            or car_y3 - 80 < car_y or car_y4 - 80 < car_y:
                        if car_x4 == car_x or car_x5 == car_x or \
                                car_x2 == car_x or car_x3 == car_x:
                            car_move = 5  # if car is on another, set speed 5
                car_y += car_move  # Car moves down by random speed
                car_position = pygame.Rect(car_x, car_y, 45, 45)
                screen.blit(chosen_car, car_position)  # Print car
