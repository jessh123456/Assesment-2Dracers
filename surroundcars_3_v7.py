""" surroundcars_3_v7  TRIALLING
    For some reason, this code won't work. after hours of trying to get it to
    run correctly, I have decided that I am going to scrap this code, and start
    again"""
...
def game_loop():
    ...
    car_appearance = random.randrange(300, 500)  # random time cars will appear
    ...
    while not quit_game:  # For future use when the 'x' in the corner is used
        while not game_over:
            ...
            if first_time:  # to start cars
                ...
                car_appearance = 500  # random time next
                # car will appear
            ...
            if run:
                if car_y2 == -150:  # only choose colour and lane once
                    ...
                    while car_x2 == car_x:  # Car_x isn't in same lane as
                        # car_x
                        car_x2 = random.choice(car_x_option)
            ...
            if run3:
                if car_y3 == -150:  # only choose colour and lane once
                    ...
                    while car_x3 == car_x2:  # Car_x3 isn't in same lane as
                        # car_x2
                        car_x3 = random.choice(car_x_option)  # Choose a lane
            ...
            if run4:
                if car_y4 == -150:  # only choose colour and lane once
                    ...
                    while car_x4 == car_x3:  # Car_x4 isn't in same lane as
                        # car_x3
                        car_x4 = random.choice(car_x_option)  # Choose a lane
            ...
            if run5:
                if car_y == -150:  # only choose colour and lane once
                    chosen_car = random.choice(cars)  # Choose a colour
                    car_x = random.choice(car_x_option)  # Choose a lane
                    while car_x == car_x4:  # Car_x isn't in same lane as
                        # car_x4
                        car_x = random.choice(car_x_option)  # Choose a lane
                    car_move = random.randrange(5, 9)  # Random speed
                car_y += car_move  # Car moves down by random speed
